  ...
  return (
    <div className={classes.container}>
      <div className={classes.imagesContainer}>
        {/* {apartmentDetails && <ImageGallery images={getApartmentImages(apartmentDetails)} />} */}
      </div>

      <div className={classes.cardsContainer}>{apartmentDetails && <ApartmentDetailCards details={apartmentDetails} />}</div>
    </div>
  );
};
